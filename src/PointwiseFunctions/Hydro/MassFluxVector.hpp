...
/// euclidean_area_element of the Strahlkorper should be used, and \f$s_i\f$ is
...
tnsr::I<DataType, Dim, Frame> mass_flux_vector(
...
///
/// Can be retrieved using `hydro::Tags::MassFluxVector`
template <typename DataType, size_t Dim, typename Frame>
struct MassFluxVectorCompute : MassFluxVector<DataType, Dim, Frame>,
                               db::ComputeTag {
  static constexpr auto function = &mass_flux_vector<DataType, Dim, Frame>;
  using argument_tags =
