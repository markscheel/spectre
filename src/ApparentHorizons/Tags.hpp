...
/// Computes the Euclidean-space integral of a vector over a Strahlkorper,
/// \f$\oint V^i s_i d^2 S\f$, where \f$s_i\f$ is the Strahlkorper surface
/// unit normal, normalized according to the Euclidean norm
/// \f$s_i s_j \delta^{ij}=1\f$.
template <typename IntegrandTag, typename Frame>
