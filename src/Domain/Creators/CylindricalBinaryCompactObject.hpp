 ...
 * - \f$|c_A^0|<=|c_B^0|\f$. We should roughly have \f$r_A c_A^0 + r_B c_B^0\f$
 *   close to zero, that is, for BBHs the center of mass should be roughly at
 *   the origin.
 * - \f$0 < r_B < r_A\f$
 * - \f$R >= 3(|c_A^0|-|c_B^0|)\f$; otherwise the blocks will be too compressed
