...
struct InitializeInterpolationTarget {
  ...
  // Custom tag for Domain that contains convert_option_to_constructor_argument.
  ...
  struct CustomDomainTag : db::SimpleTag {
    ...
    using options_tag = OptionTags::DomainCreator<VolumeDim, Frame>;
    ::Domain<VolumeDim, Frame> convert_option_to_constructor_argument(
